...
./main -input ./scene/scene3_01_cube_orthographic.txt -size 200 200 -output ./result/output3_01.tga
./main -input ./scene/scene3_02_cube_perspective.txt -size 200 200 -output ./result/output3_02.tga
./main -input ./scene/scene3_03_bunny_mesh_200.txt -size 200 200 -output ./result/output3_03.tga
./main -input ./scene/scene3_04_bunny_mesh_1k.txt -size 200 200 -output ./result/output3_04.tga
./main -input ./scene/scene3_05_axes_cube.txt -size 200 200 -output ./result/output3_05.tga
./main -input ./scene/scene3_06_crazy_transforms.txt -size 200 200 -output ./result/output3_06.tga
./main -input ./scene/scene3_07_plane.txt -size 200 200 -output ./result/output3_07.tga
./main -input ./scene/scene3_08_sphere.txt -size 200 200 -output ./result/output3_08.tga
./main -input ./scene/scene3_08_sphere.txt -size 200 200 -output ./result/output3_08.tga
./main -input ./scene/scene3_08_sphere.txt -size 200 200 -output ./result/output3_08.tga
./main -input ./scene/scene3_08_sphere.txt -size 200 200 -output ./result/output3_08.tga
./main -input ./scene/scene3_09_exponent_variations.txt -size 300 300 -output ./result/output3_09.tga
./main -input ./scene/scene3_10_exponent_variations_back.txt -size 300 300 -output ./result/output3_10.tga
./main -input ./scene/scene3_11_weird_lighting_diffuse.txt -size 200 200 -output ./result/output3_11.tga
./main -input ./scene/scene3_12_weird_lighting_specular.txt -size 200 200 -output ./result/output3_12.tga
